    ...
    <main className="home-main-content">
      <section className="home-section-content">
        <article className="home-subcontain">
          ...
          <p>
            Tus nuevos Choco-Caramelo Frappuccino, Avellana Choco-Caramelo <br/> Latte
            Helado & Avellana Choco-Caramelo Latte estan aquí
          </p>
          <button className='btn-one'>Escoge tu favorito y disfrútalo</button>
        </article>
        <article className="home-subcontain">
             <img className="home-img-hero" src={pictureOne} alt='Choco-Caramelo Frappuccino, Avellana Choco-Caramelo Latte
      ...
      <section className="home-section-content">
        ...
        <h2>EL CORAZÓN DE NUESTRAS BEBIDAS</h2>
          <p>
          ¡Colombia, Espresso Roast y Colombia Nariño!
          </p>
      ...
      <section className="home-section-content">
        ...
        <h2>¡Pide sin hacer fila!</h2>
          <p>
          Encuentra la tienda que más te convenga para hacer tu pedido, selecciónala, escoge lo que más te guste, después agrégalo a tu carrito de compras y ¡listo!, así de fácil puedes tener tu pedido Starbucks.
          </p>
          <button>¡Pide ya!</button>

        </article>
        <article className="home-subcontain">
         <img className="home-img-hero" src={pictureThree} alt='Pide sin filas'  />

        </article>
      </section>
      <section className="home-section-content">
        <article className="home-subcontain-two">
         <img className="home-img-hero" src={pictureFour} alt='Nuestro Compromiso'  />
      ...
      <section className="home-section-content">
        ...
        <article className="home-subcontain">
         <img className="home-img-hero" src={pictureFive} alt='Nuestra Comida'  />

        </article>
      </section>
      <section className="home-section-content">
        <article className="home-subcontain">
         <img className="home-img-hero" src={pictureSix} alt='Terminos y condiciones'  />
